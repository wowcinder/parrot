package com.voole.parrot.rpc.service.controller;
...
import com.voole.parrot.rpc.service.controller.rpc.SpringMVCGwtRpcProxyUtilInterface;

@Controller
@RequestMapping("ParrotTestWeb/rpc")
