 ...
 * @date 2013年12月26日
 */
public class LogModelVersionDuplicateEditor extends
		SimpleWindowEditor<LogModelVersion> {

	protected interface Driver
			extends
			SimpleBeanEditorDriver<LogModelVersion, LogModelVersionDuplicateEditor> {

	}

	private final LogModelVersion from;

	public LogModelVersionDuplicateEditor(LogModelVersion from) {
	...
	protected void add(LogModelVersion t) {
		RpcServiceUtils.LogModelRpcService.duplicateVerion(t, from,
