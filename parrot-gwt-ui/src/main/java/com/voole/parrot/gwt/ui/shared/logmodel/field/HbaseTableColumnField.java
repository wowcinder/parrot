package com.voole.parrot.gwt.ui.shared.logmodel.field;
...
public class HbaseTableColumnField extends SimpleTriggerField<HbaseTableColumn> {
	...
	public HbaseTableColumnField(LogModelLeafColumnEditor columnEditor) {
	...
	public static class HbaseTableColumnFieldCell extends
		...
		private final LogModelLeafColumnEditor columnEditor;

		public HbaseTableColumnFieldCell(
				LogModelLeafColumnEditor columnEditor) {
