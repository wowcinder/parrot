...
import com.voole.parrot.gwt.ui.shared.logmodel.field.HbaseTableVersionField;
 ...
 * @date 2013年12月26日
 */
public class LogModelGroupColumnEditor extends
		SimpleWindowEditor<LogModelGroupColumn> {

	protected interface Driver
			extends
			SimpleBeanEditorDriver<LogModelGroupColumn, LogModelGroupColumnEditor> {

	}

	public LogModelGroupColumnEditor() {
